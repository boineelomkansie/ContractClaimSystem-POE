    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Lecturers",
                columns: new[] { "LecturerId", "FirstName", "LastName" },
                values: new object[,]
                {
                    { 1, "Boineelo", "Mkansie" },
                    { 2, "Thabo", "Dlamini" }
            ...
            migrationBuilder.InsertData(
                table: "Contracts",
                columns: new[] { "ContractId", "Description", "LecturerId", "Title" },
                values: new object[,]
                {
                    { 1, "HCI Module Contract", 1, "HCIN6222 Contract" },
                    { 2, "Programming Module Contract", 2, "PROG6221 Contract" }
                });
